#!/bin/bash
# Termux-Games
# Coded by: Angel-iluminaty (You dont become a coder by just changing the credits)
# Github: https://github.com/Angel-iluminaty/Termux-Games



echo -e "\e[032m" "No copie el código ni proporcione créditos si está utilizando este proyecto."
